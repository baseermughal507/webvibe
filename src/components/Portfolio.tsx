  ...
  const projects = [
    {
      ...
      liveUrl: "https://health-o-nutrition.com",
      ...
      <div className="container-custom">
            ...
            >
              <CardContent className="p-0">
                <div className={`bg-gradient-to-r ${project.gradient} p-8 text-white relative overflow-hidden`}>
                  <div className="absolute top-4 right-4 opacity-20">{project.icon}</div>
                  <div className="relative z-10">
                    <Badge className="mb-4 bg-white/20 text-white border-white/30">{project.category}</Badge>
                  ...
                  <div className="mb-8">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {project.technologies.map((tech, idx) => (
                        <Badge key={idx} variant="secondary" className="bg-primary/10 text-primary hover:bg-primary/20">{tech}</Badge>
                      ))}
                    </div>
                  </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-secondary p-8 rounded-2xl">
            ...
            <p className="text-muted-foreground mb-6">Let's discuss your ideas and create something amazing together</p>
            <Button 
              className="btn-hero"
              onClick={() => {
